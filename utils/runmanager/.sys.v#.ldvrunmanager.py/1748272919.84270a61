...
from utils.loadmanager.ldvloadmanager import LDVLoadManager
from utils.opmanager.ldvoperationsmanager import LDVOperationsManager

class LDVRunManager(RunManager):
    ...
    def run(self):
        ...
        for shot_no in shot_nos:
            opmanager = LDVOperationsManager(
